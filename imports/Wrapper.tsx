import svgPaths from "./svg-0pkzwy2ymd";
                    ...
                    <div className="box-border content-stretch flex flex-col gap-2.5 items-center justify-center p-[10px] relative w-full">
                      ...
                      >
                        <div className="flex flex-row items-center justify-center overflow-clip relative size-full">
                          <div className="box-border content-stretch flex flex-row gap-[230px] h-[39px] items-center justify-center px-[23px] py-3 relative w-full">
                            <div
                              className="flex flex-col font-['Roboto:Regular',_sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6d6d6d] text-[12px] text-left text-nowrap"
                              style={{ fontVariationSettings: "'wdth' 100" }}
                            >
                            ...
                            <div
                              className="h-3 relative shrink-0 w-[17px]"
                              data-name="Vector"
                            >
                              <svg
                      ...
                      <div
                        className="bg-gradient-to-r from-[#0693e3] relative rounded-[10px] shrink-0 to-[#33a7b5] w-full"
                        data-name="Submit"
                      >
                        <div className="flex flex-row items-center justify-center overflow-clip relative size-full">
                      ...
                      <div
                        className="bg-[rgba(235,95,39,0.15)] relative rounded-[10px] shrink-0 w-full"
                      ...
                      <div
                        className="bg-[rgba(238,163,0,0.15)] relative rounded-[10px] shrink-0 w-full"
                      ...
                      <div
                        className="bg-[rgba(74,186,99,0.15)] relative rounded-[10px] shrink-0 w-full"
...
export default function Wrapper1() {
  return (
    <div className="bg-[#d8dff0] relative size-full" data-name="Wrapper">
      <Wrapper />
    </div>
  );
}